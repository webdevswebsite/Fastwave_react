            ...
            >
                <div className="item">
                    <div className="card p-5 p-lg-8 bg-white shadow-sm border-0 mx-3 mt-3">
                        <div>
                            <img alt="Image" src={require(`../../assets/images/thumbnail/01.jpg`).default} className="shadow-primary img-fluid rounded-circle d-inline" />
                        </div>
                ...
                <div className="item">
                    <div className="card p-5 p-lg-8 bg-white shadow-sm border-0 mx-3 mt-3">
                        <div>
                            <img alt="Image" src={require(`../../assets/images/thumbnail/02.jpg`).default} className="shadow-primary img-fluid rounded-circle d-inline" />
                        </div>
                        <div className="card-body p-0 mt-5">
                            <p className="text-muted">Ekocart Amazing E-commerce Template, clean code, Crative &amp; Modern design.</p>
                            <div>
                ...
                <div className="item">
                    <div className="card p-5 p-lg-8 bg-white shadow-sm border-0 mx-3 mt-3">
                        <div>
                            <img alt="Image" src={require(`../../assets/images/thumbnail/03.jpg`).default} className="shadow-primary img-fluid rounded-circle d-inline" />
                        </div>
                        <div className="card-body p-0 mt-5">
                            <p className="text-muted">Ekocart Amazing E-commerce Template, clean code, Crative &amp; Modern design.</p>
                            <div>
