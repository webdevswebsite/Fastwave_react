            ...
            <Row className="align-items-center justify-content-between">
                <Col lg={7} className="mb-6 mb-lg-0">
                    <Row className="align-items-center">
                        <div className="col-6">
                            <img src={require(`../../assets/images/about/01.jpg`).default} className="img-fluid rounded shadow" alt="..." />
                        </div>
                        <div className="col-6">
                            <img src={require(`../../assets/images/about/02.jpg`).default} className="img-fluid rounded shadow mb-5" alt="..." />
                            <img src={require(`../../assets/images/about/03.jpg`).default} className="img-fluid rounded shadow" alt="..." />
                        </div>
                    </Row>
                </Col>
                <Col lg={5}>
