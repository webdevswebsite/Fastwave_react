                                                    ...
                                                    <div className="item" key={index}>
                                                        <div className="card product-card">
                                                            {!this.WishlistItems(productdata.id) ?
                                                                <Link to=".#" className="btn-wishlist btn-sm" id="addtowish"><i className="lar la-heart" /></Link>
                                                                :
                                                                <Link to=".#" className="btn-wishlist btn-sm" id="viewwishlist"><i className="las la-heart" /></Link>
                                                            }
                                                            <Link className="card-img-hover d-block" to="">
                                                            ...
                                                            <div className="card-info">
                                                                <div className="card-body">
                                                                    <div className="product-title"><Link to=".#" className="link-title">{productdata.name}</Link>
                                                                    </div>
                                                                ...
                                                                <div className="card-footer bg-transparent border-0">
                                                                    <div className="product-link d-flex align-items-center justify-content-center">
                                                                        {!this.WishlistItems(productdata.id) ?
                                                                            <Link to=".#"  className="btn btn-compare" id="addtowish1"><i className="lar la-heart mr-1" ></i></Link>
                                                                            :
                                                                            <Link to=".#" className="btn btn-compare" id="viewwishlist1"><i className="las la-heart mr-1" ></i></Link>
                                                                        }
                                                                        {!this.CartItems(productdata.id) ?
                                                                            <Link to=".#" className="btn-cart btn btn-primary btn-animated mx-3" rel="nofollow" id="addtocard1"><i className="las la-shopping-cart mr-1" /></Link>
                                                                            :
                                                                            <Link to=".#" className="btn-cart btn btn-primary btn-animated mx-3" rel="nofollow" id="viewcart1"><i className="las la-cart-plus mr-1" /></Link>

                                                                        }
                                                                        <Link to=".#" className="btn btn-view" id="quickview1"><i className="las la-eye" /></Link>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
