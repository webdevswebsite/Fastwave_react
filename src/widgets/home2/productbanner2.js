            ...
            <Row>
                <div className="col-12 col-lg-6">
                    <div className="position-relative rounded overflow-hidden text-right shadow-sm">
                        {/* Background */}
                        <img className="img-fluid hover-zoom" src={require(`../../assets/images/product-ad/05.jpg`).default} alt="" />
                        {/* Body */}
                ...
                <div className="col-12 col-lg-6 mt-5 mt-lg-0">
                    <div className="position-relative rounded overflow-hidden text-right shadow-sm">
                        {/* Background */}
                        <img className="img-fluid hover-zoom" src={require(`../../assets/images/product-ad/06.jpg`).default} alt="" />
                        {/* Body */}
                        <div className="position-absolute top-50 pl-5 text-left">
