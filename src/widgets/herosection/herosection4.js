          ...
          <Row>
            ...
            <Col lg={9}>
              <OwlCarousel
                ...
                margin={5}
              >
                <div className="item bg-pos-rb" style={{ backgroundImage: `url(${require(`../../assets/images/electronic/bg/01.jpg`).default})` }}>
                ...
                <div className="item bg-pos-rb" style={{ backgroundImage: `url(${require(`../../assets/images/electronic/bg/02.jpg`).default})` }}>
                  <Container className="h-100">
                    <Row className="h-100 align-items-center">
                      <div className="col py-8 py-lg-0">
                        <div className="animated3"> <span className="bg-dark d-inline-block text-white px-2 py-1 mb-0">Only This Week</span>
