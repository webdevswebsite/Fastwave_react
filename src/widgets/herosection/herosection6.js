    ...
    render() {
        return (
            <section className="banner pos-r p-0">
                ...
                >
                    <div className="item bg-pos-rb" style={{ backgroundImage: `url(${require(`../../assets/images/kids/bg/01.jpg`).default})` }}>
                    ...
                    <div className="item" style={{ backgroundImage: `url(${require(`../../assets/images/kids/bg/02.jpg`).default})` }}>
                        <Container className="h-100">
                            <Row className="h-100 align-items-center text-center">
                                <Col lg={6} md={12} className="custom-py-1 position-relative z-index-1">
