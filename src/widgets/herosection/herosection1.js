                ...
                <div className="container-fluid px-lg-8">
                    <Row>
                        ...
                        <Col lg={9}>
                            ...
                            >
                                <div className="item bg-pos-rt" style={{ backgroundImage: `url(${require(`../../assets/images/bg/06.jpg`).default})` }}>
                                ...
                                <div className="item bg-pos-rt" style={{ backgroundImage: `url(${require(`../../assets/images/bg/05.jpg`).default})` }}>
                                    <Container className="h-100">
                                        <Row className="h-100 align-items-center">
