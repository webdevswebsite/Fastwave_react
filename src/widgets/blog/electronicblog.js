        ...
        <Col lg={4} className="col-12">
          ...
          <div className="card border-0 bg-transparent">
            <div className="position-relative rounded overflow-hidden">
              ...
              <img className="card-img-top hover-zoom" src={require(`../../assets/images/electronic/blog/01.jpg`).default} alt="Image" />
            </div>
        ...
        <Col lg={4} className="col-12 mt-5 mt-lg-0">
          ...
          <div className="card border-0 bg-transparent">
            <div className="position-relative rounded overflow-hidden">
              ...
              <img className="card-img-top hover-zoom" src={require(`../../assets/images/electronic/blog/02.jpg`).default} alt="Image" />
            </div>
            <div className="card-body px-0 pb-0">
              <div> <Link className="d-inline-block link-title btn-link text-small mr-2" to="#">Electronic,</Link>
                <Link className="d-inline-block link-title btn-link text-small" to="#">Accessories</Link>
        ...
        <Col lg={4} className="col-12 mt-5 mt-lg-0">
          ...
          <div className="card border-0 bg-transparent">
            <div className="position-relative rounded overflow-hidden">
              ...
              <img className="card-img-top hover-zoom" src={require(`../../assets/images/electronic/blog/03.jpg`).default} alt="Image" />
            </div>
            <div className="card-body px-0 pb-0">
              <div> <Link className="d-inline-block link-title btn-link text-small mr-2" to="#">Electronic,</Link>
                <Link className="d-inline-block link-title btn-link text-small" to="#">Accessories</Link>
