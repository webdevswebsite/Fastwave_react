                                    ...
                                    <div className="shadow-sm p-5 rounded">
                                        <div className="widget border-bottom mb-8 pb-8">
                                            ...
                                            <article>
                                                <div className="media align-items-center">
                                                    <img src={require(`../../assets/images/blog/blog-thumb/01.jpg`).default} className="mr-3" alt="..." />
                                            ...
                                            <article className="mt-5">
                                                <div className="media align-items-center">
                                                    <img src={require(`../../assets/images/blog/blog-thumb/02.jpg`).default} className="mr-3" alt="..." />
                                                    <div className="media-body">
                                                        <h5 className="h6">
                                            ...
                                            <article className="mt-5">
                                                <div className="media align-items-center">
                                                    <img src={require(`../../assets/images/blog/blog-thumb/03.jpg`).default} className="mr-3" alt="..." />
                                                    <div className="media-body">
                                                        <h5 className="h6">
                                        ...
                                        <div className="widget bg-light p-4 text-center rounded">
                                            ...
                                            <div className="position-relative mt-4">
                                                <img className="img-fluid" src={require(`../../assets/images/product-ad/04.jpg`).default} alt="" />
