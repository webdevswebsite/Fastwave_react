                                    ...
                                    <div className="card border-0 bg-transparent">
                                        ...
                                        <div className="mt-7 border-top pt-7">
                                            ...
                                            <div className="media d-block d-md-flex">
                                                <img className="img-fluid rounded mr-md-4 mb-3 mb-md-0" alt="image" src={require(`../../assets/images/thumbnail/01.jpg`).default} />
                                            ...
                                            <div className="media d-block d-md-flex mt-8">
                                                <img className="img-fluid rounded mr-md-4 mb-3 mb-md-0" alt="image" src={require(`../../assets/images/thumbnail/02.jpg`).default} />
                                                <div className="media-body">
                                                    <div className="d-flex align-items-center">
                                            ...
                                            <div className="media d-block d-md-flex mt-8">
                                                <img className="img-fluid rounded mr-md-4 mb-3 mb-md-0" alt="image" src={require(`../../assets/images/thumbnail/03.jpg`).default} />
                                                <div className="media-body">
                                                    <div className="d-flex align-items-center">
