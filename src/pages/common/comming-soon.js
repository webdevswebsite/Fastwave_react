    ...
    render() {
        return (
            <div className="page-content">
                {/*coming soon start*/}
                <section className="py-8 o-hidden bg-pos-r bg-primary" style={{ backgroundImage: `url(${require(`../../assets/images/bg/07.png`).default})` }}>
                                ...
                                <div className="p-5 rounded bg-white h-100">
                                    <Row className="justify-content-between align-items-center h-100">
                                        ...
                                        <div className="col-lg-6 col-md-12 d-none d-lg-block text-lg-right">
                                            <img className="img-fluid d-inline" src={require(`../../assets/images/coming-soon-img.png`).default} alt="" />
                                        </div>
                                    </Row>
                                </div>
                            </div>
