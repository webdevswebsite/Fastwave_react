              ...
              <Row>
                <div className="col-12 col-lg-4 col-md-6">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={require(`../../assets/images/electronic/product-ad/01.jpg`).default} alt="" />
                    {/* Body */}
                ...
                <div className="col-12 col-lg-4 col-md-6 mt-5 mt-md-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={require(`../../assets/images/electronic/product-ad/02.jpg`).default} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-50 pl-5">
                      {/* Heading */}
                ...
                <div className="col-12 col-lg-4 col-md-12 mt-5 mt-lg-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={require(`../../assets/images/electronic/product-ad/03.jpg`).default} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-50 pl-5">
          ...
          <section className="p-0">
            <div className="container-fluid pl-lg-0">
              <Row className="align-items-center">
                <div className="col-lg-4 pr-11 pt-5 custom-pb-2 rounded" style={{ backgroundImage: `url(${require(`../../assets/images/electronic/bg/03.jpg`).default})` }}>
