    ...
    return (
      <>
        ...
        <div className="page-content">
              ...
              <Row className="no-gutters">
                <div className="col-12 col-md-6">
                  <div className="position-relative overflow-hidden shadow-sm">
                    {/* Background */}
                    <img className="img-fluid w-100 hover-zoom" src={require(`../../assets/images/kids/product-ad/01.jpg`).default} alt="" />
                    {/* Body */}
                ...
                <div className="col-12 col-md-6">
                  <div className="position-relative overflow-hidden shadow-sm">
                    {/* Background */}
                    <img className="img-fluid w-100 hover-zoom" src={require(`../../assets/images/kids/product-ad/02.jpg`).default} alt="" />
          ...
          {/*product end*/}
          {/*product ad start*/}
          <section style={{ backgroundImage: `url(${require(`../../assets/images/kids/bg/03.jpg`).default})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            <Container>
