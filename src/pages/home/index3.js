        ...
        <div className="page-content">
          ...
          <section className="bg-light pt-11 mt-n11">
            <Container>
              <Row>
                <Col>
                  <div className="bg-white rounded p-6 py-11 bg-pos-rt bg-sm-none" style={{ backgroundImage: `url(${require(`../../assets/images/product-ad/05.jpg`).default})` }}>
                    <Row>
            ...
            <div className="container-fluid">
              <Row>
                ...
                <div className="col-12 col-lg-6 mt-5 mt-lg-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={require(`../../assets/images/product-ad/07.jpg`).default} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-50 pl-5">
