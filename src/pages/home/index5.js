    ...
    return (
      <>
        ...
        <div className="page-content">
              ...
              <Row>
                <div className="col-12 col-lg-6">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={require(`../../assets/images/furniture/product-ad/01.jpg`).default} alt="" />
                    {/* Body */}
                ...
                <div className="col-12 col-lg-6 mt-5 mt-lg-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={require(`../../assets/images/furniture/product-ad/02.jpg`).default} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-0 pl-5 pt-5">
          ...
          {/*hot deal end*/}
          {/*product ad start*/}
          <section style={{ backgroundImage: `url(${require(`../../assets/images/furniture/01.png`).default})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            <Container>
              <Row>
                <div className="col-12 col-lg-6">
