                                        ...
                                        <Col>
                                            <Navbar className="navbar-expand-lg navbar-light position-static">
                                                <Link className="navbar-brand logo d-lg-none" to="/">
                                                    <img className="img-fluid" src={require(`../../assets/images/logo.png`).default} alt="" />
                                                </Link>
                                                                            ...
                                                                            <div className="container p-0">
                                                                                <Row className="w-100 no-gutters">
                                                                                    ...
                                                                                    <div className="col-12 col-md-4">
                                                                                        <img className="img-fluid rounded-bottom rounded-top" src={require(`../../assets/images/header-img2.jpg`).default} alt="..." />
                                                                                    </div>
                                                                                </Row>
                                                                            </div>
                                                                        </DropdownMenu>
